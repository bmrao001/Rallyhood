...
public class RHhomeDP extends DataInjection {

	Logger logger = LogManager.getLogger(RHhomeDP.class.getName());
	...
	public static Object[][] createDP(String datarows) {
		...
		for (String dataRow : datarowsArray) {
			...
			xx[i][0] = new RHhomeDP(orPath, tdPath, configPath, dataRow);
			i++;
		}
