...
import com.web.tests.rallyhood.RHhomeChrome;
import com.web.tests.rallyhood.RHhomeDP;
import com.web.tests.rallyhood.RHhomeEdge;
import com.web.tests.rallyhood.Source;
import com.web.tests.rallyhood.SourceDP;

public class RallyhoodtestcasesEdge extends DriverManager { 
	...
	public void init(String browser, String osName) throws Exception {
		...
		loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,
				browserName);
	}
	 ...
	 */
	RHhomeEdge rhhomee = new RHhomeEdge();
	...
	public void RallyhoodTC_01(RHhomeDP dp, ITestContext context) {
		...
		rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Rallyhood Home screen is displayed and Events/Groups and Classes sections are present");
		//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
		rhhomee.Rallyhood_HomeScreen_Events_HeaderDisplay(dp, driver);
		rhhomee.Rallyhood_HomeScreen_ClassesGroups_HeaderDisplay(dp, driver);
	}
		...
		public void RallyhoodTC_02(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {
			context.setAttribute("dpName", dp.td.get("DataRow"));
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify error message on browser saying app_uid is invalid. ");
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.VerifyInvalid_app_uid(dp, driver);
		...
		public void RallyhoodTC_03(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {
			...
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify error message on browser saying app_uid is invalid. ");
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.VerifyInvalid_secret_key(dp, driver);	
		}
	...
	public void RallyhoodTC_05(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {
		context.setAttribute("dpName", dp.td.get("DataRow"));
		rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify single Events/Groups and Classes are present and clickable ");
		loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
		rhhomee.Rallyhood_HomeScreen_Events_HeaderDisplay(dp, driver);
		rhhomee.Rallyhood_HomeScreen_ClassesGroups_HeaderDisplay(dp, driver);
		rhhomee.RallyHood_ClickOnEvent_EventsListed(dp, driver);
		loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
		rhhomee.RallyHood_ClickOnGroupClasses_GroupClassesListed(dp, driver);
		rhhomee.PageUp(dp, driver);
		loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
	}
	...
	//Rallyhood Test case 06
		...
		public void RallyhoodTC_06(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify presence of Event Name, Event Date and respective Event Image for single Event Present");
			//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
			rhhomee.SingleEvent_Rallyhood_EventName_Date_image_Present(dp, driver);	
		}
		...
		public void RallyhoodTC_07(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify presence of Lable 'Attending?', Button 'Yes' and Button 'No' present in an Event ");
			rhhomee.Single_Events_Screen_Buttons_Validation(dp, driver);	
		...
		public void RallyhoodTC_08(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Event Flow when user clicks on Yes button for attending event and ability to change his selection again for single Event");
			rhhomee.Single_Event_Screen_AttendingEventFlow(dp, driver);
		}
		...
		public void RallyhoodTC_09(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Event Flow when user clicks on 'NO' button for NOT attending the event and ability to change his selection again for single Event");
			rhhomee.Single_Event_Screen_NOT_AttendingEventFlow(dp, driver);
		}
		...
		public void RallyhoodTC_10(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify ability to post comment without selecting 'Yes'/'No' button in an Event");
			rhhomee.Single_Event_Screen_Comments_Post(dp, driver);
		}
		...
		//Rallyhood Test case 11
			...
			public void RallyhoodTC_11(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify all options are working properly for an Event");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.Single_Event_CommentsPostOptions_Validation(dp, driver);
			}	
		...
		public void RallyhoodTC_12(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : 'Read More' link to view full content of an Event is enabled and Clicked in an Event ");
			rhhomee.Single_EventsScreen_ReadMore_Validation(dp, driver);		
		}
		...
		///Rallyhood Test case 13
				...
				public void RallyhoodTC_13(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
					loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
					rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to land on same page after refreshing the page, after clicking 'Yes' to attend an Events");
					rhhomee.Single_Event_Screen_AttendingEvent_PageRefresh_LandingSamePage(dp, driver);
				}
		...
		public void RallyhoodTC_14(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify presence of Group Name, Members count and respective Event Image for single Group Present ");
			rhhomee.SingleGroup_Rallyhood_GroupName_MembersCount_image_Present(dp, driver);	
		}
		...
		public void RallyhoodTC_15(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of Follow button for Class in a Group is working properly ");
			//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
			rhhomee.RallyHood_Single_GroupClasses_FollowAGroup_Verify(dp, driver);		
		}
		...
		//Rallyhood Test case 016
			...
			public void RallyhoodTC_16(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of 'Read More ..' for Groups and Classes is working properly ");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.RallyHood_Single_GroupClasses_ReadMoreExpand_Verify(dp, driver);		
			}
		...
		public void RallyhoodTC_17(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of SignUp Process by a user for Classes in a Group for an instructor");
			//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
			rhhomee.RallyHood_Single_GroupClasses_InstructorSignUp_Verify(dp, driver);		
		}
		...
		public void RallyhoodTC_18(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Instructor Name, Date and Time for Classes in a Group");
			//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
			rhhomee.RallyHood_Single_GroupClasses_InstructorName_Date_Location_Verify(dp, driver);		
		}
		...
		//Rallyhood Test case 019
			...
			public void RallyhoodTC_19(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify past dated classes are not listed in the classes");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.RallyHood_Single_GroupClasses_ClassesDate_GreaterThanCurrentDate_Verify(dp, driver);		
			}
		...
		//Rallyhood Test case 020
			...
			public void RallyhoodTC_20(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Remove Enrolled Instructor functionality in Classes of a Group");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.RallyHood_Single_GroupClasses_Instructor_RemoveButton_Verify(dp, driver);		
			}
			...
			public void RallyhoodTC_21(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of UnFollow Option for Class in a Group is working properly ");
		...
		public void RallyhoodTC_22(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify All Events are present and clickable ");
			rhhomee.Rallyhood_HomeScreen_Events_HeaderDisplay(dp, driver);
			rhhomee.Rallyhood_HomeScreen_ClassesGroups_HeaderDisplay(dp, driver);
			rhhomee.Multiple_RallyHood_ClickOnEvent_EventsListed_Verified(dp, driver);	
		}
		...
		public void RallyhoodTC_23(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify All Groups are present and clickable ");
			rhhomee.Rallyhood_HomeScreen_Events_HeaderDisplay(dp, driver);
			rhhomee.Rallyhood_HomeScreen_ClassesGroups_HeaderDisplay(dp, driver);
			rhhomee.Multiple_RallyHood_ClickOnGroups_GroupsListed_Verified(dp, driver);
		}
		...
		//Rallyhood Test case 24
			...
			public void RallyhoodTC_24(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify presence of Event Name, Event Date and respective Event Image for All Events Present ");
				rhhomee.MultipleEvents_Rallyhood_EventName_Date_image_Present(dp, driver);	
			}
		...
		public void RallyhoodTC_25(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify presence of Group Name, Members count and respective Event Image for All Groups Present ");
			//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
			rhhomee.MultipleGroups_Rallyhood_GroupName_MembersCount_image_Present(dp, driver);	
		}
		...
		public void RallyhoodTC_26(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify presence of Lable 'Attending?', Button 'Yes' and Button 'No' present in All Existing Event ");	
			rhhomee.Multiple_Events_Screen_Buttons_Validation(dp, driver);
		}
		...
		public void RallyhoodTC_27(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Event Flow when user clicks on Yes button for attending event and ability to change his selection again for All Events Available");	
			rhhomee.Multiple_Event_Screen_AttendingEventFlow(dp, driver);
		}
	...
	//Rallyhood Test case 28
		...
		public void RallyhoodTC_28(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Event Flow when user clicks on 'NO' button for NOT attending the event and ability to change his selection again for ALL Events Available");
			rhhomee.Multiple_Event_Screen_NOT_AttendingEventFlow(dp, driver);
		}
		...
		public void RallyhoodTC_29(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify ability to post comment without selecting 'Yes'/'No' button in ALL available Events");
			rhhomee.Multiple_Event_Screen_Comments_Post(dp, driver);
		}
	...
	public void RallyhoodTC_30(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
		loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
		rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify all options are working properly for ALL available Events");
		rhhomee.Multiple_Event_CommentsPostOptions_Validation(dp, driver);
	}
	...
	//Rallyhood Test case 31
		...
		public void RallyhoodTC_31(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify Author/Entered Comment/Entered Time of an Events");
			rhhomee.Single_Event_AfterCommentPOST_VerifyCommentsValue(dp, driver);
		}
	...
	public void RallyhoodTC_32(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
		loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
		rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify Author/Entered Comment/Entered Time of ALL available Events");
		rhhomee.Multiple_Event_AfterCommentPOST_VerifyCommentsValue(dp, driver);
	}	
		...
		public void RallyhoodTC_33(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify Comment Screen all options when Attending 'Yes' is selected for an Events");
			rhhomee.Single_Event_SelectionYES_VerifyComments_CommentedValues(dp, driver);
		}
		...
		public void RallyhoodTC_34(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify Comment Screen all options when Attending 'Yes' is selected for ALL available Events");
			rhhomee.Multiple_Event_SelectionYES_VerifyComments_CommentedValues(dp, driver);
		}
		...
		//Rallyhood Test case 35
				...
				public void RallyhoodTC_35(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
					loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
					rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify Comment Screen all options when Attending 'NO' is selected for an Events");
					rhhomee.Single_Event_SelectionNO_VerifyComments_CommentedValues(dp, driver);
				}
		...
		public void RallyhoodTC_36(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
			loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
			rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to post comment for an event available and verify Comment Screen all options when Attending 'NO' is selected for ALL available Events");
			rhhomee.Multiple_Event_SelectionNO_VerifyComments_CommentedValues(dp, driver);
		}
		...
		//Rallyhood Test case 37
				...
				public void RallyhoodTC_37(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
					loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
					rhhomee.TestCaseDescription(dp, driver, "TC Description : Verifying user is able to land on same page after refreshing the page, after clicking 'Yes' to attend for All available Events");
					rhhomee.Multiple_Event_Screen_AttendingEvent_PageRefresh_LandingSamePage(dp, driver);
				}					
	...
	public void RallyhoodTC_38(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
		loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
		rhhomee.TestCaseDescription(dp, driver, "TC Description : 'Read More' link to view full content of an Event is enabled and Clicked for all available Events ");
		rhhomee.Multiple_EventsScreen_ReadMore_Validation(dp, driver);		
	}
	...
	//Rallyhood Test case 039
			...
			public void RallyhoodTC_39(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of Follow button for ALL Class in a Group is working properly ");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.RallyHood_Multiple_GroupClasses_FollowAGroup_Verify(dp, driver);		
			}
			...
			public void RallyhoodTC_40(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of 'Read More...' for ALL available Groups and Classes is working properly ");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.RallyHood_Multiple_GroupClasses_ReadMoreExpand_Verify(dp, driver);		
			}		
	...
	//Rallyhood Test case 041
			...
			public void RallyhoodTC_41(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of SignUp Process by a user for Classes in a Group for an instructor for all available groups and classes");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.RallyHood_Multiple_GroupClasses_InstructorSignUp_Verify(dp, driver);	
				rhhomee.RallyHood_Multiple_GroupClasses_InstructorSignUp_Remove_Verify(dp, driver);
			}	
		...
		//Rallyhood Test case 042
				...
				public void RallyhoodTC_42(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
					...
					rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Instructor Name, Date and Time for Classes in a Group");
					//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
					rhhomee.RallyHood_Multiple_GroupClasses_InstructorName_Date_Location_Verify(dp, driver);	
					rhhomee.RallyHood_Multiple_GroupClasses_InstructorSignUp_Remove_Verify(dp, driver);
				}
			...
			//Rallyhood Test case 043
					...
					public void RallyhoodTC_43(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
						loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
						rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Remove Enrolled Instructor functionality in All Classes  all Groups");
						//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
						rhhomee.RallyHood_Multiple_GroupClasses_Instructor_RemoveButton_Verify(dp, driver);	
						rhhomee.RallyHood_Multiple_GroupClasses_InstructorSignUp_Remove_Verify(dp, driver);
					}
		...
		//Rallyhood Test case 044
				...
				public void RallyhoodTC_44(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
					loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
					rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify Functionality of Unfollow Option for ALL Class in a Group is working properly ");
					//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
					rhhomee.RallyHood_Multiple_GroupClasses_FollowAGroup_Verify(dp, driver);		
				}
		...
		//Rallyhood Test case 045
			...
			public void RallyhoodTC_45(RHhomeDP dp, ITestContext context) throws FileNotFoundException, Exception {context.setAttribute("dpName", dp.td.get("DataRow"));
				loadURL(PropertyFileUtils.getPropValuesFromConfig(Constants.WEB_PROPERTIES_FILE, "web.app.url3"), driver,browserName);
				rhhomee.TestCaseDescription(dp, driver, "TC Description : Verify past dated classes are not listed in the Classes for all Groups");
				//rhhomee.Rallyhood_Mobileview(dp, driver,browserName);
				rhhomee.RallyHood_Multiple_GroupClasses_ClassesDate_GreaterThanCurrentDate_Verify(dp, driver);	
			}
